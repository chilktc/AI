...
ALB 도메인: `http://t7-mindlog-prod-alb-1834710625.ap-northeast-2.elb.amazonaws.com`
...
- **ALB 접속점:** `http://t7-mindlog-prod-alb-1834710625.ap-northeast-2.elb.amazonaws.com`
- **IAM 권한 범위:**
