...
```
GET http://${BACKEND_HOST}:8080/api/v1/graph_nodes?user_id=9f3b9560-331d-11f1-b83f-02c91128bc03
```
...
```
PUT http://${BACKEND_HOST}:8080/api/v1/graph_nodes
...
```
POST http://${BACKEND_HOST}:8080/api/v1/graph_analyses
Content-Type: application/json
```
...
```
POST http://${BACKEND_HOST}:8080/api/v1/graph_nodes/episodes
Content-Type: application/json
```
...
**요청**:
```
GET http://${BACKEND_HOST}:8080/api/v1/graph_nodes?user_id=00000000-0000-0000-0000-000000000099
```
...
| 변수 | 값 |
|------|-----|
| `BACKEND_API_URL` | `http://${BACKEND_HOST}:8080/api/v1` |
| `STORAGE_MODE` | `proxy` |
