...
```bash
curl -s "http://10.7.10.20:8080/api/v1/graph_nodes?user_id=9f3b9560-331d-11f1-b83f-02c91128bc03" | python3 -m json.tool
```
...
curl -s -o /dev/null -w "%{http_code}" \
  "http://10.7.10.20:8080/api/v1/graph_nodes?user_id=9f3b9c5e-331d-11f1-b83f-02c91128bc03"
```
...
```bash
curl -s -X PUT "http://10.7.10.20:8080/api/v1/graph_nodes" \
...
```bash
curl -s -X POST "http://10.7.10.20:8080/api/v1/graph_analyses" \
  -H "Content-Type: application/json" \
  -d '{
    "user_id": "9f3b9560-331d-11f1-b83f-02c91128bc03",
    "session_id": "sess_mode_a_test_001",
