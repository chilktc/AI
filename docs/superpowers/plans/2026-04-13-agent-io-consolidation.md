...
| routes/podcasts.py | podcast_episodes | RESOURCE_PODCAST_EPISODE | TIER 4 완료 후 | **동기** | ✅ **화면 2** (Task 8 확장: +감정컬럼) |
...
| **최종 내용** | `segments[].script_text` | `final_output.segments` |
