...
| ~~3-B-4~~ | ~~GoT 분석 결과 저장 API~~ | ~~`POST /api/v1/graph_analyses`~~ | ❌ 불필요 — PUT /graph_nodes의 nodes/links가 category_distribution + keyword_connections 데이터를 이미 포함. `_publish_graph_to_backend()` 제거됨 (2026-04-09) |
