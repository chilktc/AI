...
### 작업 2: E2E 검증 — RDB 누적 저장 Mode A (우선순위: 🟡 중간)

> **2026-04-09 업데이트**: Backend GET/PUT /api/v1/graph_nodes 구현 완료 확인 (2026-04-08 수동 테스트).
> Mode A AI 서버 코드 전환 계획: **Plan #24** (`2026-04-09-mode-a-revival-graph-cumulative.md`) 참조.
> 현재 AI 코드는 Mode B (POST /graph_nodes/episodes) → Plan #24 구현 후 Mode A 전환 완료 예정.

**브랜치**: `feature/reasoning-*` (개발자2)  
...
| Mode A 수동 테스트 | `docs/guides/MODE_A_REVIVAL_TEST_GUIDE.md` 참조 |
