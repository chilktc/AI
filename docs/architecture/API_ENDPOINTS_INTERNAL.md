...
| `load_graph_cumulative(user_id)` | GET /api/v1/graph_nodes | 누적 그래프 조회 | publish_graph_to_rdb() |
| `put_graph_cumulative(data)` | PUT /api/v1/graph_nodes | 누적 그래프 저장 | publish_graph_to_rdb() |
